            ...
            <div class="layui-form-item" lay-filter="component-form-element">
                ...
                <div class="layui-input-block">
                    @foreach($attribute as $value)
                        <input type="checkbox" value="{{$value->id}}" name="attr_ids[]" title="({{$value->id}})  {{$value->attr_name}}" @if($value->attr_status > 0 ) checked @endif>
                    @endforeach
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline" style="width: 50px;">
                    <input type="text" name="type_sort" value="0" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-input-block">
